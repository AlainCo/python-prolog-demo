...
pyinstaller --console --onefile --clean --name %DIRNAME% src\main.py --add-data "%LIBSWIPL_PATH%;swipl/bin/." --add-data "%SWI_HOME_DIR%;swipl"  --add-data "src/prolog/*.pl;src/prolog"
